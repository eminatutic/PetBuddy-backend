        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoritePets_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentsInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RentsInfo_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentsInfo_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_RentsInfo_SpecialPackages_SpecialPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialPackagePets", x => new { x.SpecialPackageId, x.PetId });
                    table.ForeignKey(
                        name: "FK_SpecialPackagePets_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpecialPackagePets_SpecialPackages_SpecialPackageId",
                        column: x => x.SpecialPackageId,
                        principalTable: "SpecialPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentsInfo_PetId",
                table: "RentsInfo",
                column: "PetId");

            migrationBuilder.CreateIndex(
                name: "IX_RentsInfo_SpecialPackageId",
                table: "RentsInfo",
                column: "SpecialPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_RentsInfo_UserId",
                table: "RentsInfo",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialPackagePets_PetId",
                table: "SpecialPackagePets",
                column: "PetId");
        }
